#!/usr/bin/env python3
"""
Safe Häufige Fragen Article Deletion Script
...
class SafeHaeufigeFragenDeleter:
    def __init__(self, articles_dir: str):
        ...
        # Keep articles #181 and #182 - delete #183-190 (all 100% identical to #182)
        self.deletion_list = [
            "183-haeufige-fragen-183-antworten-vom-privatdetektiv.md",
            "184-haeufige-fragen-184-antworten-vom-privatdetektiv.md",
            "185-haeufige-fragen-185-antworten-vom-privatdetektiv.md",
            "186-haeufige-fragen-186-antworten-vom-privatdetektiv.md",
            "187-haeufige-fragen-187-antworten-vom-privatdetektiv.md",
            "188-haeufige-fragen-188-antworten-vom-privatdetektiv.md",
            "189-haeufige-fragen-189-antworten-vom-privatdetektiv.md",
            "190-haeufige-fragen-190-antworten-vom-privatdetektiv.md",
        ]
    ...
    def safe_deletion_process(self):
        ...
        print(f"🚀 Starting safe deletion of {len(self.deletion_list)} duplicate Häufige Fragen articles")
        ...
        for i, filename in enumerate(self.deletion_list, 1):
            ...
            if self.delete_article(filename):
                ...
                if self.test_blog_system():
                    ...
                    backup_file = self.project_dir / "blog" / f"articles_backup_haeufige_fragen_20251226_220339" / filename
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("📊 HÄUFIGE FRAGEN DELETION SUMMARY")
        print("="*60)
        ...
        print("   Preserved unique articles: #181, #182")

def main():
    articles_dir = "/Users/fabianradlow/Documents/Code-Projekte/Operation Bona Fides/blog/articles"
    deleter = SafeHaeufigeFragenDeleter(articles_dir)

    success = deleter.safe_deletion_process()

    if success:
        print("\n🎉 Safe Häufige Fragen deletion process completed successfully!")
    else:
