#!/usr/bin/env python3
"""
Safe Branchenstatistik Article Deletion Script
...
class SafeBranchenstatistikDeleter:
    def __init__(self, articles_dir: str):
        ...
        # Keep articles #161 and #162 - delete #163-170 (all 100% identical to #162)
        self.deletion_list = [
            "163-branchenstatistik-163-aktuelle-trends-im-cybercrime.md",
            "164-branchenstatistik-164-aktuelle-trends-im-cybercrime.md",
            "165-branchenstatistik-165-aktuelle-trends-im-cybercrime.md",
            "166-branchenstatistik-166-aktuelle-trends-im-cybercrime.md",
            "167-branchenstatistik-167-aktuelle-trends-im-cybercrime.md",
            "168-branchenstatistik-168-aktuelle-trends-im-cybercrime.md",
            "169-branchenstatistik-169-aktuelle-trends-im-cybercrime.md",
            "170-branchenstatistik-170-aktuelle-trends-im-cybercrime.md",
        ]
    ...
    def safe_deletion_process(self):
        ...
        print(f"🚀 Starting safe deletion of {len(self.deletion_list)} duplicate Branchenstatistik articles")
        ...
        for i, filename in enumerate(self.deletion_list, 1):
            ...
            if self.delete_article(filename):
                ...
                if self.test_blog_system():
                    ...
                    backup_file = self.project_dir / "blog" / f"articles_backup_branchenstatistik_20251226_212718" / filename
    ...
    def print_summary(self):
        ...
        print("\\n" + "="*60)
        print("📊 BRANCHENSTATISTIK DELETION SUMMARY")
        print("="*60)
        ...
        print("   Preserved unique articles: #161, #162")

def main():
    articles_dir = "/Users/fabianradlow/Documents/Code-Projekte/Operation Bona Fides/blog/articles"
    deleter = SafeBranchenstatistikDeleter(articles_dir)

    success = deleter.safe_deletion_process()

    if success:
        print("\\n🎉 Safe Branchenstatistik deletion process completed successfully!")
    else:
