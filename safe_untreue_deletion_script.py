#!/usr/bin/env python3
"""
Safe Untreue Article Deletion Script
Deletes duplicate articles one by one with system testing after each deletion
Based on analysis: 12 duplicate articles identified (80% reduction)
"""
...
class SafeUntreuDeleter:
    def __init__(self, articles_dir: str):
        ...
        # Keep articles #76, #77, #78 - delete #79-90 (all 100% identical to #78)
        self.deletion_list = [
            "079-untreue-79-wie-man-digitale-hinweise-erkennt.md",
            "080-untreue-80-wie-man-digitale-hinweise-erkennt.md",
            "081-untreue-81-wie-man-digitale-hinweise-erkennt.md",
            "082-untreue-82-wie-man-digitale-hinweise-erkennt.md",
            "083-untreue-83-wie-man-digitale-hinweise-erkennt.md",
            "084-untreue-84-wie-man-digitale-hinweise-erkennt.md",
            "085-untreue-85-wie-man-digitale-hinweise-erkennt.md",
            "086-untreue-86-wie-man-digitale-hinweise-erkennt.md",
            "087-untreue-87-wie-man-digitale-hinweise-erkennt.md",
            "088-untreue-88-wie-man-digitale-hinweise-erkennt.md",
            "089-untreue-89-wie-man-digitale-hinweise-erkennt.md",
            "090-untreue-90-wie-man-digitale-hinweise-erkennt.md",
        ]
    ...
    def safe_deletion_process(self):
        ...
        print(f"🚀 Starting safe deletion of {len(self.deletion_list)} duplicate Untreue articles")
        ...
        for i, filename in enumerate(self.deletion_list, 1):
            ...
            if self.delete_article(filename):
                ...
                if self.test_blog_system():
                    ...
                    backup_file = self.project_dir / "blog" / f"articles_backup_untreue_20251226_215540" / filename
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("📊 UNTREUE DELETION SUMMARY")
        print("="*60)
        ...
        print("   Preserved unique articles: #76, #77, #78")

def main():
    articles_dir = "/Users/fabianradlow/Documents/Code-Projekte/Operation Bona Fides/blog/articles"
    deleter = SafeUntreuDeleter(articles_dir)

    success = deleter.safe_deletion_process()

    if success:
        print("\n🎉 Safe Untreue deletion process completed successfully!")
    else:
