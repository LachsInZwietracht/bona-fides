#!/usr/bin/env python3
"""
Safe Internationale Ermittlungen Article Deletion Script
...
class SafeInternationaleErmittlungenDeleter:
    def __init__(self, articles_dir: str):
        ...
        # Keep articles #1 and #192 - delete #193-200 (all 100% identical to #192)
        self.deletion_list = [
            "193-internationale-ermittlungen-193-grenzen-ueberschreitende-faelle-loesen.md",
            "194-internationale-ermittlungen-194-grenzen-ueberschreitende-faelle-loesen.md",
            "195-internationale-ermittlungen-195-grenzen-ueberschreitende-faelle-loesen.md",
            "196-internationale-ermittlungen-196-grenzen-ueberschreitende-faelle-loesen.md",
            "197-internationale-ermittlungen-197-grenzen-ueberschreitende-faelle-loesen.md",
            "198-internationale-ermittlungen-198-grenzen-ueberschreitende-faelle-loesen.md",
            "199-internationale-ermittlungen-199-grenzen-ueberschreitende-faelle-loesen.md",
            "200-internationale-ermittlungen-200-grenzen-ueberschreitende-faelle-loesen.md",
        ]
    ...
    def safe_deletion_process(self):
        ...
        print(f"🚀 Starting safe deletion of {len(self.deletion_list)} duplicate Internationale Ermittlungen articles")
        ...
        for i, filename in enumerate(self.deletion_list, 1):
            ...
            if self.delete_article(filename):
                ...
                if self.test_blog_system():
                    ...
                    backup_file = self.project_dir / "blog" / f"articles_backup_rechtliche_aspekte_20251226_195716" / filename
    ...
    def print_summary(self):
        ...
        print("\\n" + "="*60)
        print("📊 INTERNATIONALE ERMITTLUNGEN DELETION SUMMARY")
        print("="*60)
        ...
        print("   Preserved unique articles: #1, #192")

def main():
    articles_dir = "/Users/fabianradlow/Documents/Code-Projekte/Operation Bona Fides/blog/articles"
    deleter = SafeInternationaleErmittlungenDeleter(articles_dir)

    success = deleter.safe_deletion_process()

    if success:
        print("\\n🎉 Safe Internationale Ermittlungen deletion process completed successfully!")
    else:
